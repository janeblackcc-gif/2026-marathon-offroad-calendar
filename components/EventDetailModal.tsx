        ...
        <div className="p-6 sm:p-8 space-y-6 sm:space-y-8 overflow-y-auto no-scrollbar">
            ...
            <section>
                ...
                {loadingMap ? (
                  ...
                  <div className="bg-slate-50 rounded-2xl p-4 sm:p-6 border border-slate-100 text-center">
                    <p className="text-xs sm:text-sm text-slate-500 font-bold">暂时无法获取精确地图信息</p>
                  </div>
                )}
            </section>
